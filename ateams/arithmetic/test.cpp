...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "ateams.arithmetic.test",
        "sources": [
            "ateams/arithmetic/test.pyx"
        ]
    },
    "module_name": "ateams.arithmetic.test"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ateams__arithmetic__test
#define __PYX_HAVE_API__ateams__arithmetic__test
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from "ateams.arithmetic.test" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "ateams.arithmetic.test"
extern int __pyx_module_is_main_ateams__arithmetic__test;
int __pyx_module_is_main_ateams__arithmetic__test = 0;

/* Implementation of "ateams.arithmetic.test" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_ateams__arithmetic__test) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ateams.arithmetic.test")) {
      if (unlikely((PyDict_SetItemString(modules, "ateams.arithmetic.test", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_test(void)", __pyx_f[0], 2, 0, __PYX_ERR(0, 2, __pyx_L1_error));

  /* "ateams/arithmetic/test.pyx":2
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init ateams.arithmetic.test", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init ateams.arithmetic.test");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
