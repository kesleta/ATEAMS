...
from ..arithmetic import flatCubicalComplex, flatBoundaryMatrix, flatten
...
class FlatLattice:
    ...
    def _construct(
        ...
        if not data:
            v, b, boundary, coboundary = flatCubicalComplex(self.corners, self.dimension, self.field, self.periodicBoundaryConditions)
